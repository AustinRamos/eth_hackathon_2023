...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    apiKey: {
      ...
      polygonMumbai: "WCI89JKWH9MPZ6F6XSDCU8AQATHR32EPYS",
      goerli: "P3NP2612RAEKHK4SCBTG8NU7F67HWQESQQ",
    },
  },
  typechain: {
    outDir: "./types",
...
task(
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const ica = await router["getDeployedInterchainAccount(uint32,address)"](
      originDomain,
      taskArgs.address
    );
    console.info(
